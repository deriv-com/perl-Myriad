...
requires 'XS::Parse::Sublike', '>= 0.32';
requires 'Object::Pad', '>= 0.817';
requires 'Role::Tiny', '>= 2.002004';
requires 'Data::Checks', '>= 0.09';
requires 'Object::Pad::FieldAttr::Checked';
requires 'Object::Pad::FieldAttr::Final', '>= 0.06';
requires 'Object::Pad::FieldAttr::Isa', '>= 0.05';
requires 'Object::Pad::FieldAttr::Trigger', '>= 0.07';
requires 'Object::Pad::FieldAttr::LazyInit', '>= 0.07';
requires 'Object::Pad::Operator::Of', '>= 0.01';
requires 'Object::Pad::LexicalMethods', '>= 0.01';
requires 'Object::Pad::Keyword::Accessor', '>= 0.03';
...
# Transport
requires 'Net::Async::Redis', '>= 6.005';
